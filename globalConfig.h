...
private:
	std::string_view    m_configPath = R"(LogConfig.json)";
...
#endif
	if (bytesConverted == static_cast<size_t>(-1) || bytesConverted == 0)
		return {};
	return { buffer, bytesConverted };
}